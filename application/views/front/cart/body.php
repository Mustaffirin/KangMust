				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ul>
							...
							<li>Apabila pembelian/pendaftaran Pasang Baru IndiHome (PSB), silakan lakukan konfirmasi ke kontak marketting untuk share lokasi dan Foto KTP Anda, guna mengecek ketersedian jaringan di area lokasi serta Aktivasi Biodata Diri anda</li>
						</ul>
					</div>
				</div>
