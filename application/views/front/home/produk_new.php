<hr>
<h4 align="center">Produk Terbaru</h4>
<hr>
<div class="row">
        ...
        <a href="<?php echo base_url("produk/$produk->slug_produk ") ?>">
          <?php
            if (empty($produk->foto)) {
              ...
              echo "<img class='card-img-top' src='" . base_url() . "assets/images/produk/" . $produk->foto . '_thumb' . $produk->foto_type . "'> ";
            }
            ?>
        </a>
        <div class="card-body">
          ...
          <p align="center">
            ...
            <b>Rp <?php echo number_format($produk->harga_diskon) ?></b>
