        ...
        <div class="row">
          ...
          <div class='col-lg-4'>
            <div class='small-box bg-red'>
              <div class='inner'><h3> <?php echo $total_featured ?> </h3><p><b>PRODUK RECOMENDED</b></p></div>
          ...
          <div class='col-lg-4'>
            ...
            <div class='small-box bg-green'>
              <div class='inner'><h3> <?php echo $total_blog ?> </h3><p><b>BLOG</b></p></div>
              <div class='icon'><i class='fa fa-star'></i></div>
          ...
          <div class='col-lg-4'>
            <div class='small-box bg-blue'>
              <div class='inner'><h3> <?php echo $total_user ?> </h3><p><b>USER ACCOUNT</b></p></div>
              <div class='icon'><i class='fa fa-star'></i></div>
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="box-footer">
                  <button href='<?php echo base_url('admin/auth') ?>' type="button" name="button" class="btn btn-primary">Lihat Selengkapnya</button>
                </div>
              </div>
            </div>
          </div>
