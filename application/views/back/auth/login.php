  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url('assets/template/backend/') ?>index2.html"><b>Administrator</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <?php echo form_close();?>
        <dive><p><a href="http://zonaindihome.com" a lign="right"><b>Kembali ke Website</b></a></p></dive>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
